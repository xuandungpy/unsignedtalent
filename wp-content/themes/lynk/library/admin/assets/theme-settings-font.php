...
<div class="jvbpd_ts_tab javo-opts-group-tab hidden" tar="font">
	<!-- Themes setting > Font -->
	<h2><?php esc_html_e("Fonts Settings", 'jvfrmtd' );?></h2>
	<table class="form-table">
	<tr><th>
		<?php esc_html_e('Basic Font', 'jvfrmtd' );?>
		<span class="description">
			<?php esc_html_e('Setup font size, tags', 'jvfrmtd' );?>
		</span>
	</th><td>
		<h4><?php esc_html_e("Choose basic font-family",'jvfrmtd' ); ?></h4>
		<fieldset>
		...
		<h4><?php esc_html_e("Normal Font size",'jvfrmtd' ); ?></h4>
		<fieldset>
		...
		<h4><?php esc_html_e("Line height",'jvfrmtd' ); ?></h4>
		<fieldset>
			<div style="width:400px; display:inline-block; margin:0 15px 0 0;">
		...
		<?php esc_html_e('H1', 'jvfrmtd' );?>
		<span class="description">
			<?php esc_html_e('Setup font size, tags', 'jvfrmtd' );?>
		</span>
	</th><td>
		<h4><?php esc_html_e("Choose H1 font-family",'jvfrmtd' ); ?></h4>
		<fieldset>
		...
		<h4><?php esc_html_e("H1 Font size",'jvfrmtd' ); ?></h4>
		<fieldset>
			<div style="width:400px; display:inline-block; margin:0 15px 0 0;">
	...
	<?php esc_html_e('H2', 'jvfrmtd' );?>
		<span class="description">
			<?php esc_html_e('Setup font size, tags', 'jvfrmtd' );?>
		</span>
	</th><td>
		<h4><?php esc_html_e("Choose H2 font-family",'jvfrmtd' ); ?></h4>
		<fieldset>
		...
		<h4><?php esc_html_e("H2 Font size",'jvfrmtd' ); ?></h4>
		<fieldset>
			<div style="width:400px; display:inline-block; margin:0 15px 0 0;">
	...
	<?php esc_html_e('H3', 'jvfrmtd' );?>
		<span class="description">
			<?php esc_html_e('Setup font size, tags', 'jvfrmtd' );?>
		</span>
	</th><td>
		<h4><?php esc_html_e("Choose H3 font-family",'jvfrmtd' ); ?></h4>
		<fieldset>
		...
		<h4><?php esc_html_e("H3 Font size",'jvfrmtd' ); ?></h4>
		<fieldset>
			<div style="width:400px; display:inline-block; margin:0 15px 0 0;">
		...
		<?php esc_html_e('H4', 'jvfrmtd' );?>
		<span class="description">
			<?php esc_html_e('Setup font size, tags', 'jvfrmtd' );?>
		</span>
	</th><td>
		<h4><?php esc_html_e("Choose H4 font-family",'jvfrmtd' ); ?></h4>
		<fieldset>
		...
		<h4><?php esc_html_e("H4 Font size",'jvfrmtd' ); ?></h4>
		<fieldset>
			<div style="width:400px; display:inline-block; margin:0 15px 0 0;">
		...
		<?php esc_html_e('H5', 'jvfrmtd' );?>
		<span class="description">
			<?php esc_html_e('Setup font size, tags', 'jvfrmtd' );?>
		</span>
	</th><td>
		<h4><?php esc_html_e("Choose H5 font-family",'jvfrmtd' ); ?></h4>
		<fieldset>
		...
		<h4><?php esc_html_e("H5 Font size",'jvfrmtd' ); ?></h4>
		<fieldset>
			<div style="width:400px; display:inline-block; margin:0 15px 0 0;">
		...
		<?php esc_html_e('H6', 'jvfrmtd' );?>
		<span class="description">
			<?php esc_html_e('Setup font size, tags', 'jvfrmtd' );?>
		</span>
	</th><td>
		<h4><?php esc_html_e("Choose H6 font-family",'jvfrmtd' ); ?></h4>
		<fieldset>
		...
		<h4><?php esc_html_e("H6 Font size",'jvfrmtd' ); ?></h4>
		<fieldset>
			<div style="width:400px; display:inline-block; margin:0 15px 0 0;">

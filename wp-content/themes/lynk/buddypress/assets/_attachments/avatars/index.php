...
<script id="tmpl-bp-avatar-delete" type="text/html">
	<# if ( 'user' === data.object ) { #>
		...
		<p><a class="button edit" id="bp-delete-avatar" href="#"><?php esc_html_e( 'Delete My Profile Photo', 'jvfrmtd' ); ?></a></p>
	<# } else if ( 'group' === data.object ) { #>
		...
		<p><a class="button edit" id="bp-delete-avatar" href="#"><?php esc_html_e( 'Delete Group Profile Photo', 'jvfrmtd' ); ?></a></p>
	<# } else { #>

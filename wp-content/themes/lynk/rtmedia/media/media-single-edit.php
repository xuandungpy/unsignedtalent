	...
	if ( have_rtmedia() ) : rtmedia();
		if ( rtmedia_edit_allowed() ) {
			...
			<div class="rtmedia-single-edit-title-container">
				<h2 class="rtmedia-title"><?php esc_html_e( 'Edit Media', 'jvfrmtd' ); ?></h2>
			</div>
				...
				<div class="rtmedia-editor-main">
					...
					<div class="rtm-tabs-content">
						<div class="content" id="panel1">
							...
							<div class="rtmedia-edit-title rtm-field-wrap">
								<label><?php esc_html_e( 'Title : ', 'jvfrmtd' ); ?></label>
							...
							<div class="rtmedia-editor-description rtm-field-wrap">
								<label><?php esc_html_e( 'Description: ', 'jvfrmtd' ) ?></label>
								<?php
					...
					<div class="rtmedia-editor-buttons">
						<input type="submit" class="button rtm-button rtm-button-save"
						       value="<?php esc_attr_e( 'Save', 'jvfrmtd' ); ?>"/>
			...
			?>
			<p><?php esc_html_e( 'Sorry !! You do not have rights to edit this media', 'jvfrmtd' ); ?></p>
			<?php
		} else :
		?>
		<p class="rtmedia-no-media-found">
			<?php
			apply_filters( 'rtmedia_no_media_found_message_filter', esc_html_e( 'Sorry !! There\'s no media found for the request !!','jvfrmtd' ) );
			?>
		</p>
		<?php
	endif; // End if().

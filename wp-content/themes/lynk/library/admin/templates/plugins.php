...
<div class="wrap about-wrap" id="jv-default-setting-plugins-wrap">
	<div class="feature-section theme-browser rendered">
		<?php
			...
			?>
			<div class="theme <?php echo sanitize_html_class( $plugin['slug'] ) . ' ' . sanitize_html_class( $class ); ?>" data-slug="<?php echo $plugin['slug']; ?>">
					...
					<?php
						...
						if( $plugin['required'] ): ?>
							<div class="plugin-required">
								<?php esc_html_e( 'Required', 'jvfrmtd' ); ?>
							</div>
						<?php
						endif;
					?>
				...
				<?php if( isset( $plugin_action['update'] ) && $plugin_action['update'] ): ?>
					<div class="theme-update">
						<?php esc_html_e( "Update Available:", 'jvfrmtd' ); ?>
						<?php esc_html_e( "Version", 'jvfrmtd' ); ?>
	...
	<div class="spinner-wrap">
		...
		<span class="spinner-text"><?php esc_html_e( "Processing...", 'jvfrmtd' ); ?></span>
	</div>
</div>
;( function( $ ) {
	"use strict";
	var jvbpd_wp_media = function( opt )
	{
		if( ! window.__JAVO_WP_MEDIA__ )
		{
			...
			this.attr = $.extend( true, {}, {
				...
				, input_name			: "jvbpd_detail_images[]"
			}, opt );
	...
	jvbpd_wp_media.prototype = {
		constructor : jvbpd_wp_media
		, init : function ()
		{
			var opt			= this.attr;
			$( document )
	...
	jQuery.jvbpd_wp_media = function(opt){
		new jvbpd_wp_media(opt);
	};
} )( jQuery );
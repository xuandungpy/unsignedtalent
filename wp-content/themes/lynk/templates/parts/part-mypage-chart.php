...
<div class="card-header">
	<h4 class="card-title">
		...
		<a href="<?php echo jvbpd_getUserPage( jvbpd_getDashboardUser()->ID, 'report-settings' ); ?>" class="btn btn-primary btn-sm pull-right m-r-20 btn-rounded hidden-xs hidden-sm"><?php esc_html_e( "Setting", 'jvfrmtd' ); ?></a>
	</h4>
</div>

...
<div id="buddypress-inner">
	...
	<form action="" method="post" id="blogs-directory-form" class="dir-form">
		...
		<div class="item-list-tabs" aria-label="<?php esc_attr_e( 'Sites directory main navigation', 'jvfrmtd' ); ?>" role="navigation">
			<ul>
				<li class="selected" id="blogs-all"><a href="<?php bp_root_domain(); ?>/<?php bp_blogs_root_slug(); ?>"><?php printf( __( 'All Sites %s', 'jvfrmtd' ), '<span>' . bp_get_total_blog_count() . '</span>' ); ?></a></li>

				<?php if ( is_user_logged_in() && bp_get_total_blog_count_for_user( bp_loggedin_user_id() ) ) : ?>

					<li id="blogs-personal"><a href="<?php echo bp_loggedin_user_domain() . bp_get_blogs_slug(); ?>"><?php printf( __( 'My Sites %s', 'jvfrmtd' ), '<span>' . bp_get_total_blog_count_for_user( bp_loggedin_user_id() ) . '</span>' ); ?></a></li>
		...
		<div class="item-list-tabs" id="subnav" aria-label="<?php esc_attr_e( 'Sites directory secondary navigation', 'jvfrmtd' ); ?>" role="navigation">
			<ul>
				...
				<li id="blogs-order-select" class="last filter">
					...
					<label for="blogs-order-by"><?php _e( 'Order By:', 'jvfrmtd' ); ?></label>
					<select id="blogs-order-by">
						<option value="active"><?php _e( 'Last Active', 'jvfrmtd' ); ?></option>
						<option value="newest"><?php _e( 'Newest', 'jvfrmtd' ); ?></option>
						<option value="alphabetical"><?php _e( 'Alphabetical', 'jvfrmtd' ); ?></option>
